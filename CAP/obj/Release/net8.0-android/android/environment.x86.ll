...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 125, ; uint32_t number_of_assemblies_in_apk (0x7d)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 574, ; uint32_t number_of_dso_cache_entries (0x23e)
	i32 33555164, ; uint32_t android_runtime_jnienv_class_token (0x20002dc)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [574 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.77_name, ; name: libaot-System.Numerics.Vectors.dll.so
		ptr null; void* handle (0x0)
	}, ; 4
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.27_name, ; name: libaot-SQLitePCLRaw.provider.e_sqlite3.dll.so
		ptr null; void* handle (0x0)
	}, ; 6
	%struct.DSOCacheEntry {
		i64 94620481, ; hash 0x5a3cb41, from name: aot-netstandard
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.93_name, ; name: libaot-netstandard.dll.so
		ptr null; void* handle (0x0)
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 131361316, ; hash 0x7d46a24, from name: CAP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CAP.dll.so
		ptr null; void* handle (0x0)
	}, ; 10
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.22_name, ; name: libaot-Plugin.LocalNotification.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	%struct.DSOCacheEntry {
		i64 319734269, ; hash 0x130ec1fd, from name: libaot-System.Web.HttpUtility
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.90_name, ; name: libaot-System.Web.HttpUtility.dll.so
		ptr null; void* handle (0x0)
	}, ; 37
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 343253266, ; hash 0x1475a112, from name: libaot-CAP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CAP.dll.so
		ptr null; void* handle (0x0)
	}, ; 43
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.73_name, ; name: libaot-System.Memory.dll.so
		ptr null; void* handle (0x0)
	}, ; 48
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 459842215, ; hash 0x1b68a2a7, from name: libaot-CAP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CAP.dll.so
		ptr null; void* handle (0x0)
	}, ; 57
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.78_name, ; name: libaot-System.ObjectModel.dll.so
		ptr null; void* handle (0x0)
	}, ; 63
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-SQLitePCLRaw.core.dll.so
		ptr null; void* handle (0x0)
	}, ; 65
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.24_name, ; name: libaot-SQLitePCLRaw.batteries_v2.dll.so
		ptr null; void* handle (0x0)
	}, ; 71
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.71_name, ; name: libaot-System.Linq.Expressions.dll.so
		ptr null; void* handle (0x0)
	}, ; 102
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.72_name, ; name: libaot-System.Linq.dll.so
		ptr null; void* handle (0x0)
	}, ; 117
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.81_name, ; name: libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 153
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.26_name, ; name: libaot-SQLitePCLRaw.lib.e_sqlite3.android.dll.so
		ptr null; void* handle (0x0)
	}, ; 208
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.79_name, ; name: libaot-System.Private.Uri.dll.so
		ptr null; void* handle (0x0)
	}, ; 242
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3004929569, ; hash 0xb31b9621, from name: aot-CAP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CAP.dll.so
		ptr null; void* handle (0x0)
	}, ; 403
	...
	%struct.DSOCacheEntry {
		i64 3856826757, ; hash 0xe5e28185, from name: CAP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CAP.dll.so
		ptr null; void* handle (0x0)
	}, ; 514
	...
	%struct.DSOCacheEntry {
		i64 3932458299, ; hash 0xea648d3b, from name: aot-CAP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CAP.dll.so
		ptr null; void* handle (0x0)
	}, ; 526
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [125 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
...
@.env.3 = private unnamed_addr constant [37 x i8] c"aaca6e87-a983-45ec-941d-b20646ffbbde\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [20 x i8] c"com.companyname.cap\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [18 x i8] c"libaot-CAP.dll.so\00", align 1
...
@.DSOCacheEntry.22_name = private unnamed_addr constant [39 x i8] c"libaot-Plugin.LocalNotification.dll.so\00", align 1
@.DSOCacheEntry.23_name = private unnamed_addr constant [25 x i8] c"libaot-SQLite-net.dll.so\00", align 1
@.DSOCacheEntry.24_name = private unnamed_addr constant [40 x i8] c"libaot-SQLitePCLRaw.batteries_v2.dll.so\00", align 1
@.DSOCacheEntry.25_name = private unnamed_addr constant [32 x i8] c"libaot-SQLitePCLRaw.core.dll.so\00", align 1
@.DSOCacheEntry.26_name = private unnamed_addr constant [49 x i8] c"libaot-SQLitePCLRaw.lib.e_sqlite3.android.dll.so\00", align 1
@.DSOCacheEntry.27_name = private unnamed_addr constant [46 x i8] c"libaot-SQLitePCLRaw.provider.e_sqlite3.dll.so\00", align 1
...
@.DSOCacheEntry.71_name = private unnamed_addr constant [38 x i8] c"libaot-System.Linq.Expressions.dll.so\00", align 1
@.DSOCacheEntry.72_name = private unnamed_addr constant [26 x i8] c"libaot-System.Linq.dll.so\00", align 1
@.DSOCacheEntry.73_name = private unnamed_addr constant [28 x i8] c"libaot-System.Memory.dll.so\00", align 1
...
@.DSOCacheEntry.77_name = private unnamed_addr constant [38 x i8] c"libaot-System.Numerics.Vectors.dll.so\00", align 1
@.DSOCacheEntry.78_name = private unnamed_addr constant [33 x i8] c"libaot-System.ObjectModel.dll.so\00", align 1
@.DSOCacheEntry.79_name = private unnamed_addr constant [33 x i8] c"libaot-System.Private.Uri.dll.so\00", align 1
@.DSOCacheEntry.80_name = private unnamed_addr constant [33 x i8] c"libaot-System.Private.Xml.dll.so\00", align 1
@.DSOCacheEntry.81_name = private unnamed_addr constant [64 x i8] c"libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so\00", align 1
...
@.DSOCacheEntry.90_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 1
...
@.DSOCacheEntry.93_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 1
